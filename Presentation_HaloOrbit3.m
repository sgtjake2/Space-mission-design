% 2 Lunar Orbits = 4717440 seconds
...
xlabel("Yr (m)")
ylabel("Zr (m)")
title(["Satalite Path in Rotational Plane (Scaled)",""])
...
xlim([-3000*2000 3000*2000])
ylim([-3000*2000 3000*2000])

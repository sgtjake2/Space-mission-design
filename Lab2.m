...
surf(X2+5,Y2-5,Z2,FaceColor="yellow")
...
z1 = y.*sin(i);
plot3(x1,y1,z1,'*','Color','blue','MarkerSize',10,...
...
plot3(x03,y03,z03,'o','Color','red','MarkerSize',10,...
    'MarkerFaceColor','red')

legend("Mercury","Venus","Earth","Mars","Sun","Periapsis","Epoch")

a = [0 250];
b = [0 0];
c = [0 0];

plot3(a,b,c,"Color","black","LineWidth",2.5)
